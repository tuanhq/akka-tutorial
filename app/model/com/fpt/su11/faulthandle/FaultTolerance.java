...
public class FaultTolerance {
  ...
  public static void main(String[] args) {
    ...
    ActorRef listener = system
        .actorOf(Props.create(Listener.class), "listener");
    ...
    public void onReceive(Object msg) {
      ...
      if (msg.equals(Start) && progressListener == null) {
        ...
        getContext()
            .system()
            .scheduler()
            .schedule(Duration.Zero(), Duration.create(1, "second"), getSelf(),
                Do, getContext().dispatcher(), null);
        ...
        pipe(
            ask(counterService, GetCurrentCount, askTimeout).mapTo(
                classTag(CurrentCount.class)).map(
                new Mapper<CurrentCount, Progress>() {
                  public Progress apply(CurrentCount c) {
                    return new Progress(100.0 * c.count / totalCount);
                  }
                }, getContext().dispatcher()), getContext().dispatcher()).to(
            progressListener);
      } else {
        unhandled(msg);
      }
  ...
  public interface CounterServiceApi {
    ...
    public static class CurrentCount {
      ...
      public String toString() {
        return String.format("%s(%s, %s)", getClass().getSimpleName(), key,
            count);
      }
    }
  ...
  public static class CounterService extends UntypedActor {
     ...
     */
    void initStorage() {
      storage = getContext().watch(
          getContext().actorOf(Props.create(Storage.class), "storage"));
    ...
    public void onReceive(Object msg) {
      ...
      if (msg instanceof Entry && ((Entry) msg).key.equals(key)
        ...
        getContext()
            .system()
            .scheduler()
            .scheduleOnce(Duration.create(10, "seconds"), getSelf(), Reconnect,
